...
<?php
// Ambil ID jadwal yang akan di ubah
if (isset($_GET['id'])) {
    $id = $_GET['id'];
...
function buildOptions($table, $idField, $namaField, $selectedId) {
    global $conn;
    $options = "";
    ...
    while ($r = $res->fetch_assoc()) {
        ...
        $options .= "<option value='".$r[$idField]."' $selected>".$r[$namaField]."</option>";
    }
    return $options;
}
?>
...
<div class="content" style="margin-top: 70px;">
    <form action="" method="post" class="border border-success p-4 rounded shadow">
        ...
        <div class="mb-3">
            ...
            <?= buildOptions("matkul","id", "namaMatkul", $row['id_matkul']);?>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <?= buildOptions("dosen","id", "namaDosen", $row['id_dosen']);?>
            </select>
        </div>
